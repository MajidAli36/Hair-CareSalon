/**
 * Apply product usage_kind migration (IPv4 pooler fallback).
 */
...
const migrationFile = resolve(
  __dirname,
  "../supabase/migrations/20250907220000_product_usage_kind.sql"
);
const version = "20250907220000_product_usage_kind.sql";
