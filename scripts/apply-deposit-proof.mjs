/**
 * Apply deposit proof image migration (IPv4 pooler fallback).
 */
...
const migrationFile = resolve(
  __dirname,
  "../supabase/migrations/20250904140000_deposit_proof_image.sql"
);
const version = "20250904140000_deposit_proof_image.sql";
