/**
 * Apply sale payment status migration (IPv4 pooler fallback).
 */
...
const migrationFile = resolve(
  __dirname,
  "../supabase/migrations/20250904120000_sale_payment_status.sql"
);
const version = "20250904120000_sale_payment_status.sql";
