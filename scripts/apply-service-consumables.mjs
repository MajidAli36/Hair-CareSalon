/**
 * Apply service consumables migration (IPv4 pooler fallback).
 */
...
const migrationFile = resolve(
  __dirname,
  "../supabase/migrations/20250907210000_service_consumables.sql"
);
const version = "20250907210000_service_consumables.sql";
